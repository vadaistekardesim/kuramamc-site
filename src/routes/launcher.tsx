...
import { Download, Cpu, ShieldCheck, Zap, Server, MessageCircle, LogIn, UserPlus, ChevronRight } from 'lucide-react';
import { useEffect, useState } from "react";
import { useServerFn } from "@tanstack/react-start";
import heroBg from "@/assets/hero-bg.jpg";
import logo from "@/assets/logo.png";
import launcherMockup from "@/assets/launcher-mockup.png"; // Launcher görsetini buraya bağlayabilirsin
      ...
      <section className="relative isolate overflow-hidden pb-12">
        ...
        <header className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          ...
          <nav className="absolute left-1/2 hidden -translate-x-1/2 items-center gap-1 rounded-full border border-white/10 bg-black/30 px-2 py-2 backdrop-blur md:flex">
            ...
            <Link to="/launcher" className="rounded-full px-4 py-2 text-sm text-foreground transition">Launcher</Link>
        ...
        <div className="relative z-10 mx-auto flex flex-col items-center pt-8 text-center px-4">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-white tracking-tight mb-4 font-display max-w-3xl leading-tight">
