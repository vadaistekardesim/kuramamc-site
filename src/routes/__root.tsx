...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cherry blossom temalı, kaliteli ve kararlı bir Minecraft deneyimi." },
      { property: "og:title", content: "KuramaMC" },
      { property: "og:description", content: "Farklı bir Minecraft deneyimi." },
